// Generated from /home/darla/Documentos/testeantlrpascal/PascalSimplificado.g4 by ANTLR 4.13.1
...
public class PascalSimplificadoParser extends Parser {
	...
	public static final int
		...
		END=10, WRITE=11, FILE=12, FOR=13, FUNCTION=14, GOTO=15, IF=16, IN=17, 
		LABEL=18, MOD=19, NIL=20, NOT=21, WRITELN=22, OF=23, OR=24, PACKED=25, 
		PROCEDURE=26, PROGRAM=27, RECORD=28, REPEAT=29, SET=30, THEN=31, TO=32, 
		READ=33, TYPE=34, UNTIL=35, VAR=36, WHILE=37, WITH=38, INTEGER=39, REAL=40, 
		BOOLEAN=41, CHAR=42, STRING=43, TRUE=44, FALSE=45, SOMA=46, SUBTRACAO=47, 
		MULTIPLICACAO=48, DIVISAO=49, MAIOR=50, MENOR=51, MAIORIGUAL=52, MENORIGUAL=53, 
		DIFERENTE=54, IGUAL=55, ATRIBUICAO=56, PONTOEVIRGULA=57, VIRGULA=58, PONTO=59, 
		DOISPONTOS=60, PARENTESESESQUERDO=61, PARENTESESDIREITO=62, IDENT=63, 
		STRING_LITERAL=64, INTEIRO=65, WS=66, COMENTARIO=67;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'DOWNTO'", "'ELSE'", "'END'", "'WRITE'", "'FILE'", "'FOR'", "'FUNCTION'", 
			"'GOTO'", "'IF'", "'IN'", "'LABEL'", "'MOD'", "'NIL'", "'NOT'", "'WRITELN'", 
			"'OF'", "'OR'", "'PACKED'", "'PROCEDURE'", "'PROGRAM'", "'RECORD'", "'REPEAT'", 
			"'SET'", "'THEN'", "'TO'", "'READ'", "'TYPE'", "'UNTIL'", "'VAR'", "'WHILE'", 
			"'WITH'", "'INTEGER'", "'REAL'", "'BOOLEAN'", "'CHAR'", "'STRING'", "'TRUE'", 
			"'FALSE'", "'+'", "'-'", "'*'", "'/'", "'>'", "'<'", "'>='", "'<='", 
			"'<>'", "'='", "':='", "';'", "','", "'.'", "':'", "'('", "')'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ELSE", "END", "WRITE", "FILE", "FOR", "FUNCTION", "GOTO", "IF", "IN", 
			"LABEL", "MOD", "NIL", "NOT", "WRITELN", "OF", "OR", "PACKED", "PROCEDURE", 
			"PROGRAM", "RECORD", "REPEAT", "SET", "THEN", "TO", "READ", "TYPE", "UNTIL", 
			"VAR", "WHILE", "WITH", "INTEGER", "REAL", "BOOLEAN", "CHAR", "STRING", 
			"TRUE", "FALSE", "SOMA", "SUBTRACAO", "MULTIPLICACAO", "DIVISAO", "MAIOR", 
			"MENOR", "MAIORIGUAL", "MENORIGUAL", "DIFERENTE", "IGUAL", "ATRIBUICAO", 
			"PONTOEVIRGULA", "VIRGULA", "PONTO", "DOISPONTOS", "PARENTESESESQUERDO", 
			"PARENTESESDIREITO", "IDENT", "STRING_LITERAL", "INTEIRO", "WS", "COMENTARIO"
		};
	}
	...
	public static class ProgramaContext extends ParserRuleContext {
		...
		public TerminalNode IDENT() { return getToken(PascalSimplificadoParser.IDENT, 0); }
	...
	public final Cont_sentencasContext cont_sentencas() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -9223371890284746752L) != 0)) {
				{
				setState(102);
				sentencas();
				}
	...
	public static class ComandoContext extends ParserRuleContext {
		...
		public TerminalNode PARENTESESESQUERDO() { return getToken(PascalSimplificadoParser.PARENTESESESQUERDO, 0); }
		public Var_readContext var_read() {
			return getRuleContext(Var_readContext.class,0);
		}
		public TerminalNode PARENTESESDIREITO() { return getToken(PascalSimplificadoParser.PARENTESESDIREITO, 0); }
